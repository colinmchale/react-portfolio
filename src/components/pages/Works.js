...
export default function Works() {
  return (
    <div style={{marginTop: 60}} id="works">
      <h1 style={styles.headerColor}>Some of my <i>work</i>...</h1>
    ...
    <div className="card col-6 p-1 m-2 border-0 cardGlow" style={styles.cardWidth}>
        <img className="card-img-top border border-bottom-0 border-white rounded-top h-50" src={lookBook} alt="LookBook"/>
        ...
        <a href="https://young-anchorage-47013.herokuapp.com/" target="_blank" rel="noreferrer" className="card-link" style={styles.linkColor}>Live</a>
      ...
      <div className="card col-6 p-1 m-2 border-0 cardGlow" style={styles.cardWidth}>
        <img className="card-img-top border border-bottom-0 border-white rounded-top h-50" src={mathQuiz} alt="Math Quiz"/>
        <div className="card-body rounded-bottom h-50" style={styles.cardColor}>
        <h5 className="card-title">Math Quiz</h5>
        <p className="card-text">Javascript/CSS/HTML</p>
        <a href="https://colinmchale.github.io/CodeQuiz/" target="_blank" rel="noreferrer" className="card-link" style={styles.linkColor}>Live</a>
      ...
      <div className="card col-6 p-1 m-2 border-0 cardGlow" style={styles.cardWidth}>
        <img className="card-img-top border border-bottom-0 border-white rounded-top h-50" src={lyricalHacker} alt="Lyrcial Hackers"/>
        <div className="card-body rounded-bottom h-50" style={styles.cardColor}>
        <h5 className="card-title">Lyrcial Hackers</h5>
        <p className="card-text">Javascript/Express.js/CSS/HTML</p>
        <a href="https://colinmchale.github.io/ProjectforHackers/" target="_blank" rel="noreferrer" className="card-link" style={styles.linkColor}>Live</a>
      ...
      <div className="card col-6 p-1 m-2 border-0 cardGlow" style={styles.cardWidth}>
        <img className="card-img-top border border-bottom-0 border-white rounded-top h-50" src={passwordGenerator} alt="Password Generator"/>
        <div className="card-body rounded-bottom h-50" style={styles.cardColor}>
        <h5 className="card-title">Password Generator</h5>
        <p className="card-text">Javascript/HTML</p>
        <a href="https://colinmchale.github.io/PasswordGenerator/" target="_blank" rel="noreferrer" className="card-link" style={styles.linkColor}>Live</a>
      ...
      <div className="card col-6 p-1 m-2 border-0 cardGlow" style={styles.cardWidth}>
        <img className="card-img-top border border-bottom-0 border-white rounded-top h-50" src={workDayScheduler} alt="Workday Scheduler"/>
        <div className="card-body rounded-bottom h-50" style={styles.cardColor}>
        <h5 className="card-title">Workday Scheduler</h5>
        <p className="card-text">HTML/Javascript with local storage</p>
        <a href="https://colinmchale.github.io/WorkDayScheduler/" target="_blank" rel="noreferrer" className="card-link" style={styles.linkColor}>Live</a>
      ...
      <div className="card col-6 p-1 m-2 border-0 cardGlow" style={styles.cardWidth}>
        <img className="card-img-top border border-bottom-0 border-white rounded-top h-50" src={noteTaker} alt="Note Taker"/>
        <div className="card-body rounded-bottom h-50" style={styles.cardColor}>
        <h5 className="card-title">Note Taker</h5>
        <p className="card-text">Javascript/Express.js/CSS/HTML</p>
        <a href="https://whispering-harbor-33313.herokuapp.com/" target="_blank" rel="noreferrer" className="card-link" style={styles.linkColor}>Live</a>
