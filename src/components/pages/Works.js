  ...
  return (
    <div style={{ marginTop: 60 }} id="works">
      ...
      <div className="mt-4 d-flex flex-wrap text-white justify-content-center">
        ...
        >
          <img
            className="card-img-top border border-bottom-0 border-white rounded-top h-50"
            src={lookBook}
            alt="LookBook"
          />
          <div
          ...
          >
            ...
            <p className="card-text">
              Javascript/SQL/Sequalize/MVC/Express.js/CSS/HTML
            </p>
            <a
        ...
        >
          ...
          >
            ...
            <a
              href="https://colinmchale.github.io/ProjectforHackers/"
              target="_blank"
              rel="noreferrer"
              className="card-link"
              style={styles.linkColor}
            ...
            <a
              href="https://github.com/colinmchale/ProjectforHackers"
              target="_blank"
              rel="noreferrer"
              className="card-link"
              style={styles.linkColor}
        ...
        >
          ...
          >
            ...
            <a
              href="https://colinmchale.github.io/PasswordGenerator/"
              target="_blank"
              rel="noreferrer"
              className="card-link"
              style={styles.linkColor}
            ...
            <a
              href="https://github.com/colinmchale/PasswordGenerator"
              className="card-link"
              target="_blank"
              rel="noreferrer"
              style={styles.linkColor}
        ...
        >
          ...
          >
            ...
            <p className="card-text">Javascript/Express.js/CSS/HTML</p>
            <a
              href="https://whispering-harbor-33313.herokuapp.com/"
              target="_blank"
              rel="noreferrer"
              className="card-link"
              style={styles.linkColor}
            ...
            <a
              href="https://github.com/colinmchale/NoteTaker"
              target="_blank"
              rel="noreferrer"
              className="card-link"
              style={styles.linkColor}
