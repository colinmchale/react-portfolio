    ...
    <div style={{marginTop: 30, marginBottom: 20}} id="contact">
      ...
      <form onSubmit={sendEmail}>
        <div className="form-group" style={styles.margin}>
          ...
          <input type="text" name="name" className="form-control" value={toSend.name} onChange={handleChange} style={styles.fontColor}/>
        </div>
        <div className="form-group" style={styles.margin}>
          <label htmlFor="email" style={styles.fontColor}>Email Address:</label>
          <input type="email" name="email" className="form-control" value={toSend.email} onChange={handleChange} style={styles.fontColor}/>
        </div>
        <div className="form-group" style={styles.margin}>
          <label htmlFor="subject" style={styles.fontColor}>Subject:</label>
          <input type="text" name="subject" className="form-control" value={toSend.subject} onChange={handleChange} style={styles.fontColor}/>
        </div>
        <div className="form-group" style={styles.margin}>
          <label htmlFor="message" style={styles.fontColor}>Message:</label>
          <textarea className="form-control" name="message" value={toSend.message} onChange={handleChange} rows="3" style={styles.fontColor}></textarea>
        </div>
